...
import static api.performance.ChartCreator.toLineChartPict;
...
public class PerformanceTest {
    ...
    public void performanceTest() throws InterruptedException {
        ...
        assertEquals(String.format("There is %s unsuccessful responses", RestAssuredThread.failures), 0,
                RestAssuredThread.failures);
    }
}
